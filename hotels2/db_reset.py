...
def reset_db():
    ...
    rooms = [
        vars(Room(hotel_ids[0], 2, 1, 150.0, True)),
        vars(Room(hotel_ids[0], 2, 2, 250.0, True)),
        vars(Room(hotel_ids[0], 3, 3, 350.0, True)),
        vars(Room(hotel_ids[0], 4, 4, 400.0, True)),
        vars(Room(hotel_ids[1], 1, 1, 110.0, True)),
        vars(Room(hotel_ids[1], 2, 2, 265.0, False)),
        vars(Room(hotel_ids[1], 2, 3, 270.0, True)),
        vars(Room(hotel_ids[1], 2, 4, 250.0, True)),
        vars(Room(hotel_ids[1], 3, 5, 300.0, True)),
        vars(Room(hotel_ids[1], 4, 6, 460.0, False)),
    ]
    ...
    passwords = ["1234", "5432", "7654", "7868", "4432"]
